...
model = custNN.Autoencoder([1000, 750, 600, 450, 300, 150, 75, 30, 10, 2], nn.Tanh(), nn.Tanh(), F.tanh)
...
trainset = ds.CustomAutoencoderDataset3D(data_dir+"trainG3D", side, transform) #2DGH32
...
optimizer = torch.optim.Adam(model.parameters(), lr=5e-4); epochs = 150
